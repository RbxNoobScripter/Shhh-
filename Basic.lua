...
MainFrame.BackgroundColor3 = Color3.fromRGB(25, 25, 112) -- Light brown
...
Title.BackgroundColor3 = Color3.fromRGB(25, 25, 112) -- Lighter brown
...
ToggleButton.MouseButton1Click:Connect(function()
    ...
    ToggleButton.Text = ringPartsEnabled and "Black Hole On" or "Black Hole Off"
...
StarterGui:SetCore("SendNotification", {
    Title = "Join my TikTok account @antiodernoobz",
    Text ="Enjoy bro! 😜",
    Duration = 5
})

-- Get player thumbnail
local userId = Players:GetUserIdFromNameAsync("AntiOderNoobz")
local thumbType = Enum.ThumbnailType.HeadShot
local thumbSize = Enum.ThumbnailSize.Size420x420
local content, isReady = Players:GetUserThumbnailAsync(userId, thumbType, thumbSize)

StarterGui:SetCore("SendNotification", {
    Title = "Enjoy mini bro",
    Text = ":)",
    Icon = content,
    Duration = 5
})
...
SendChatMessage("Hello from anti-oder-noobz!")
SendChatMessage("Enjoy:)")
SendChatMessage("Venom")
SendChatMessage("#SaveRoblox")
